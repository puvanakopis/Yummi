            ...
            <div className="products-table">
                ...
                {filteredProducts.map(product => (
                    <div key={product._id} className="table-row">
                        ...
                        <div className="table-cell">{product.Stock || 'N/A'}</div>
                        <div className="table-cell">
                            {product.Img && <img src={`http://localhost:4000/${product.Img}`} alt={product.Name} width="50" />}
                        </div>
                    ...
                    <div className="modal" ref={modalRef}>
                        ...
                        <form onSubmit={handleSubmit} encType="multipart/form-data">
                            ...
                            <div className="modal-actions">
                                ...
                                <button type="button" className="btn delete" onClick={() => { setShowForm(false); setEditingProduct(null); }}>Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
